...
START TRANSACTION;
USE `lorehunterdb`;
INSERT INTO `post` (`id`, `subject`, `created_at`, `status`, `last_edited`, `comment_count`, `category_id`, `user_id`, `content`, `enabled`) VALUES (1, '[Reddit Rumor] Embargo preview FFXVI lifted next week', '2023-03-03T12:35:22', 'active', '2023-03-03T12:35:22', 1, 1, 1, 'Two Italian reviewers have stated that an important game\'s embargo will expire at the end of the month, and have hinted that it is FFXVI (preview). Obviously do not take this information as 100% certain, we will find out in the coming days. To avoid NDA problems I will avoid specifying who they are.', 1);
INSERT INTO `post` (`id`, `subject`, `created_at`, `status`, `last_edited`, `comment_count`, `category_id`, `user_id`, `content`, `enabled`) VALUES (2, '12th Colossus', '2023-03-03T12:35:22', 'active', '2023-03-03T12:35:22', 1, 2, 2, 'Paradise floats upon the lake....', 1);
INSERT INTO `post` (`id`, `subject`, `created_at`, `status`, `last_edited`, `comment_count`, `category_id`, `user_id`, `content`, `enabled`) VALUES (3, 'Elden Ring DLC Announced - Shadow of the Erdtree Expansion', '2023-03-03T12:35:22', 'active', '2023-03-03T12:35:22', 1, 3, 1, 'Rise, Tarnished, and let us walk a new path together.\nAn upcoming expansion for #ELDENRING Shadow of the Erdtree, is currently in development. We hope you look forward to new adventures in the Lands Between.', 1);
INSERT INTO `post` (`id`, `subject`, `created_at`, `status`, `last_edited`, `comment_count`, `category_id`, `user_id`, `content`, `enabled`) VALUES (4, 'Giving Elden Ring another chance', '2023-03-03T12:35:22', 'active', '2023-03-03T12:35:22', 1, 4, 2, 'I\'m thinking about giving ER another chance, but for realsies this time. I got it on launch and liked it well enough to sink 20-30 hours into it before I started low-key hating the game. I gave up somewhere into the second area behind the castle, after being overwhelmed with all the systems, weapons, and things to do. I had a constant feeling of FOMO and anxiety, especially reading the OT here on Era where everybody talked about builds and ever-changing balancing issues from patches. Never once did I just relax and enjoy exploring the world, there was always this sense that I was playing it wrong in some way that I couldn\'t quite place my finger on.', 1);
INSERT INTO `post` (`id`, `subject`, `created_at`, `status`, `last_edited`, `comment_count`, `category_id`, `user_id`, `content`, `enabled`) VALUES (5, 'The Ad Reporting Thread', '2023-03-03T12:35:22', 'active', '2023-03-03T12:35:22', 1, 5, 1, 'Please use this thread to report bad ads (e.g. full-screen takeovers, pop-ups, redirects, etc.). We make it a high priority to ensure that intrusive ads don\'t show up on the site and to get them removed as quickly as possible so that you can keep having a great experience.', 1);
INSERT INTO `post` (`id`, `subject`, `created_at`, `status`, `last_edited`, `comment_count`, `category_id`, `user_id`, `content`, `enabled`) VALUES (6, 'Games of the Year Awards 2022', '2023-03-03T12:35:22', 'active', '2023-03-03T12:35:22', 1, 6, 2, 'Top 20 Games of 2022', 1);
