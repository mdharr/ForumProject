...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `created_at`, `image_url`, `last_activity`, `status`, `comment_count`, `banner_message`, `post_count`, `state`, `banner_image`) VALUES (2, 'Wander', '$2a$10$4SMKDcs9jT18dbFxqtIqDeLEynC7MUrCEUbv1a/bhO.x9an9WGPvm', 1, 'ADMIN', 'Michael', 'Harrington', 'wander@sotc.com', '2023-03-03T12:35:22', 'https://cdn.discordapp.com/attachments/1080302897599877181/1080303009180946562/ico-profile-picture.jpeg', '2023-03-03T12:35:22', 'active', 2, 'Raise thy sword by the light.', 3, 'offline', 'https://savepointweb.files.wordpress.com/2016/10/analisis_ico_sotc_classics_hd.jpg');
