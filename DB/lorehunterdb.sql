...
START TRANSACTION;
USE `lorehunterdb`;
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `created_at`, `image_url`, `last_activity`, `status`, `comment_count`, `banner_message`, `post_count`, `state`, `banner_image`) VALUES (1, 'Wesker', '$2a$10$4SMKDcs9jT18dbFxqtIqDeLEynC7MUrCEUbv1a/bhO.x9an9WGPvm', 1, 'ADMIN', 'Albert', 'Wesker', 'wesker@re.com', '2023-03-03T12:35:22', 'https://i.pinimg.com/736x/55/88/47/5588473ad336e9826e4036f8a508d9b8.jpg', '2023-03-03T12:35:22', 'active', 3, 'I am the master of this domain.', 1, 'offline', 'https://gamecloud.net.au/wp-content/uploads/2014/05/Resident-Evil-Banner.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `created_at`, `image_url`, `last_activity`, `status`, `comment_count`, `banner_message`, `post_count`, `state`, `banner_image`) VALUES (2, 'Wander', '$2a$10$4SMKDcs9jT18dbFxqtIqDeLEynC7MUrCEUbv1a/bhO.x9an9WGPvm', 1, 'ADMIN', 'Michael', 'Harrington', 'wander@sotc.com', '2023-03-03T12:35:22', 'https://cdn.discordapp.com/attachments/1080302897599877181/1080303009180946562/ico-profile-picture.jpeg', '2023-03-03T12:35:22', 'active', 2, 'Raise thy sword by the light, and head to the place where the sword\'s light gathers.', 3, 'offline', 'https://savepointweb.files.wordpress.com/2016/10/analisis_ico_sotc_classics_hd.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `created_at`, `image_url`, `last_activity`, `status`, `comment_count`, `banner_message`, `post_count`, `state`, `banner_image`) VALUES (3, 'Snake', '$2a$10$4SMKDcs9jT18dbFxqtIqDeLEynC7MUrCEUbv1a/bhO.x9an9WGPvm', 1, 'ADMIN', 'Solid', 'Snake', 'snake@mgs.com', '2023-03-03T12:35:22', 'https://1.bp.blogspot.com/-VtNMBLJexIg/UEUABciRBMI/AAAAAAAAIBs/IJLeyg4ELYk/s1600/Old_Snake_by_metalgearsolid.jpg', '2023-03-03T12:35:22', 'active', 5, 'A legend is nothing but fiction. Someone tells it, someone else remembers it, everybody passes it on.', 2, 'offline', 'https://cdn2.steamgriddb.com/file/sgdb-cdn/hero_thumb/8ba9f7401e1f60f3024ad195d4a24d8e.jpg');
